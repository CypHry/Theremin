...
Projekt ma na celu stworzenie theremina, w którym rolę anten spełniać będą dwa czujniki odległościowe - jeden do określania częstotliwości fali dźwiękowej, a drugi do jej amplitudy. 
